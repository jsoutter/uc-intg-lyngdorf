...
COPY ./pylyngdorflib /app/pylyngdorflib
...
LABEL org.opencontainers.image.source https://github.com/jsoutter/intg-lyngdorf

CMD ["python3", "-u", "intg-lyngdorf/driver.py"]